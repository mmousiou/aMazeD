...
for (let i = 0; i < levelData.length; i++) {
    ...
    if (temp <= 6) {
        document.getElementById(scoreid).textContent = levelData[i].yc;
        document.getElementById(playid).textContent = levelData[i].Ab;
    } else {
        document.getElementById(scoreid).textContent = levelData[i].hl;
        document.getElementById(playid).textContent = levelData[i].dm;
    }
